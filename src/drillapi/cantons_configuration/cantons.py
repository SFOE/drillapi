CANTONS = {
    "cantons_configurations": {
        "JU": {
            ...
            "thematic_geoportal_url": "https://geo.jura.ch/theme/POI?lang=fr&map_x=2580425&map_y=1242775&map_zoom=1&baselayer_ref=sdt_01_03_mensuration_officielle&baselayer_opacity=0&tree_enable_env_18_06_cadastre_geologique=false&tree_enable_env_18_03_geothermie_limitation_forages_sondes_geothermiques=true&tree_groups=Geologie",
        ...
        "ZG": {
            ...
            "legend_url": "https://services.geo.zg.ch/ows/Erdwaermenutzung?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=zg.ews_zulaessigkeit&format=image/png&STYLE=default",
        ...
        "VS": {
            ...
            "cantonal_energy_service_url": "https://www.vs.ch/web/sen/eaux-souterraines-et-constructions",
            ...
            "layers": [
                {
                    ...
                    "property_values": [
                        ...
                        {
                            "name": "3",
                            "desc": "Au cas par cas – Etude préalable (contexte hydrogéologique ou autres restrictions)",
                            "target_harmonized_value": 2,
                        },
                        {
                            "name": "4",
                            "desc": "Au cas par cas – Etude préalable (danger de glissement de terrain ou effondrement)",
                            "target_harmonized_value": 2,
                        },
                        {
                            "name": "5",
                            "desc": "Sondes géothermiques non admises",
                            "target_harmonized_value": 3,
                        },
                    ],
                }
        ...
        "UR": {
            ...
            "legend_url": "https://geo.ur.ch/webmercator/wms?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=umwelt:wnk_zulaessigkeitsbereiche_erdsonden&format=image/png",
        ...
        "SZ": {
            ...
            "legend_url": "https://map.geo.sz.ch/mapserv_proxy?service=WMS&request=GetLegendGraphic&version=1.1.1&layer=ch.sz.a034c.waermenutzung.erdwaerme.technisch&format=image/png&FORMAT_OPTIONS=dpi:200",
        ...
        "SH": {
            ...
            "legend_url": "https://wms.geo.sh.ch/wms?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=sh.energie.erdsonden.eignung&format=image/png",
        ...
        "SG": {
            ...
            "legend_url": "https://services.geo.sg.ch/wss/service/SG00025_WMS/guest?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=Zulaessigkeitsbereich&format=image/png",
        ...
        "OW": {
            ...
            "legend_url": "https://www.gis-daten.ch/wms/bfe_kann_ich_bohren/service?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=ch.ow.ews_zulaessigkeit&format=image/png",
        ...
        "NW": {
            ...
            "wms_url": "https://www.gis-daten.ch/wms/bfe_kann_ich_bohren/service",
            "query_url": "https://www.gis-daten.ch/wms/bfe_kann_ich_bohren/service",
            "legend_url": "https://www.gis-daten.ch/wms/bfe_kann_ich_bohren/service?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=ch.nw.waermenutzungsbereiche&format=image/png",
        ...
        "BL": {
            ...
            "legend_url": "https://geowms.bl.ch/?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=erdwaerme_uebersicht_ohne_a&format=image/png&sld_version=1.1.0",
        ...
        "BE": {
            ...
            "legend_url": "https://www.geoservice.apps.be.ch/geoservice3/services/a42geo/of_utilitiescommunication01_de_ms_wms/MapServer/WMSServer?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=ERDSOND_ERDSOND_VW_16828&format=image/png",
        ...
        "AR": {
            ...
            # Legend not working due to force download
            "legend_url": "",  # "https://www.geoportal.ch/services/wms/ktar?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=ch.geoportal.ver_entsorgung_kommunikation.29.0.erdwaermesonden_kt&format=image/png",
        ...
        "AI": {
            ...
            # Legend not working due to force download
            "legend_url": "",  # "https://www.geoportal.ch/services/wms/ktai?service=WMS&request=GetLegendGraphic&version=1.3.0&layer=ch.geoportal.ver_entsorgung_kommunikation.29.0.erdwaermesonden_kt&format=image/png"
        ...
        "AG": {
            ...
            "legend_url": "https://www.ag.ch/geoportal/services/afu_erdwaerme/MapServer/WMSServer?SERVICE=WMS&REQUEST=GetLegendGraphic&VERSION=1.3.0&LAYER=Eignung_Erdwärmenutzung55223&FORMAT=image/png",
